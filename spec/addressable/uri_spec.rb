...
describe Addressable::URI, "when initialized from individual components" do
  shared_examples_for "individual component initialization" do
  ...
  context "options as symbols" do
    ...
    it_should_behave_like "individual component initialization"
  end

  context "options as strings" do
    before do
      @uri = Addressable::URI.new(
        "scheme" => "http",
        "user" => "user",
...
describe Addressable::URI, "when initialized from " +
  ...
  shared_examples_for "frozen individual components" do
    it "returns 'http' for #scheme" do
      @uri.scheme.should == "http"
    end
  ...
  context "options as symbols" do
    ...
    it_should_behave_like "frozen individual components"
  end
